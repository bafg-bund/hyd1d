...
``` {r link_pegelonline, eval = is_html, echo = FALSE, results = 'asis'}
cat('<p style="text-align: center;"><a href="https://pegelonline.wsv.de" target="_blank">https://pegelonline.wsv.de</a></p>')
```
...
``` {r link_flys, eval = is_html, echo = FALSE, results = 'asis'}
cat('<p style="text-align: center;"><a href="https://www.bafg.de/DE/08_Ref/M2/03_Fliessgewmod/01_FLYS/flys_node.html" target="_blank">FLYS – Flusshydrologischer Webdienst</a></p>')
```
...
```{r figure03, fig.show = 'asis', fig.cap = capFig(paste0("Ausgewählte stationäre FLYS3 Wasserspiegellagen (", bf("0.5MQ"), ", ", bf("a"), " und ", bf("0.75MQ"), ") und Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau.")), echo = FALSE, error = FALSE, warning = FALSE, message = FALSE}
...
``` {r link_pegelonline_restapi, eval = is_html, echo = FALSE, results = 'asis'}
...
[df.flys](reference/df.flys.html)
...
```{r figure09, fig.show = 'asis', fig.cap = capFig(paste0("Ausgewählte stationäre FLYS3 Wasserspiegellagen (", bf("0.5MQ"), " und ", bf("0.75MQ"), ") und Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau.")), echo = FALSE, error = FALSE, warning = FALSE, message = FALSE}
{
    plot(1, 1, type = "n", xlim = c(xlim_min, xlim_max), 
         ylim = c(ylim_min, ylim_max), xlab = "Flusskilometer (km)", 
         ylab = "H\u00f6he (m \u00fcber NHN (DHHN92))")
...
```{r figure10, fig.show = 'asis', fig.cap = capFig(paste0("Ausgewählte stationäre FLYS3 Wasserspiegellagen (", bf("0.5MQ"), " und ", bf("0.75MQ"), ") und Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau und deren relative Lage zwischen den FLYS3 Wasserspiegellagen.")), echo = FALSE, error = FALSE, warning = FALSE, message = FALSE}
{
    plot(1, 1, type = "n", xlim = c(xlim_min, xlim_max), 
         ylim = c(ylim_min, ylim_max), xlab = "Flusskilometer (km)", 
         ylab = "H\u00f6he (m \u00fcber NHN (DHHN92))")
...
```{r figure11, fig.show = 'asis', fig.cap = capFig(paste0("Relatives Gewicht für die Interpolation der Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau zwischen den FLYS3 Wasserspiegellagen ", bf("0.5MQ"), " und ", bf("0.75MQ"), ".")), echo = FALSE, error = FALSE, warning = FALSE, message = FALSE}
{
    plot(1, 1, type = "n", xlim = c(xlim_min, xlim_max), 
...
``` {r formula_latex, eval = !is_html, echo = FALSE, results = 'asis'}
cat('
\\begin{center}
...
``` {r formula_html, eval = is_html, echo = FALSE, results = 'asis'}
...
```{r figure12, fig.show = 'asis', fig.cap = capFig(paste0("Interpolierte Wasserspiegellage, ausgewählte stationäre FLYS3 Wasserspiegellagen (", bf("0.5MQ"), " und ", bf("0.75MQ"), ") und Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau.")), echo = FALSE, error = FALSE, warning = FALSE, message = FALSE}
{
    plot(1, 1, type = "n", xlim = c(xlim_min, xlim_max), 
         ylim = c(ylim_min, ylim_max), xlab = "Flusskilometer (km)", 
         ylab = "H\u00f6he (m \u00fcber NHN (DHHN92))")
...
```{r figure13, fig.show = 'asis', fig.cap = capFig(paste0("Interpolierte Wasserspiegellage, berechnungsrelevante stationäre FLYS3 Wasserspiegellagen (", bf("0.5MQ"), ", ", bf("a"), " und ", bf("0.75MQ"), ") und Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau.")), echo = FALSE, error = FALSE, warning = FALSE, message = FALSE}
{
...
[`WaterLevelDataFrame`](reference/WaterLevelDataFrame-class.html) nötig 
...
[`WaterLevelDataFrame`](reference/WaterLevelDataFrame-class.html) angelegt, 
...
der Klasse [`WaterLevelDataFrame`](reference/WaterLevelDataFrame-class.html) 
werden erst bei einer 
...
eines Objektes der Klasse [`WaterLevelDataFrame`](reference/WaterLevelDataFrame-class.html) 
...
```{r figure14, fig.show = 'asis', fig.cap = capFig(paste0("Interpolierte Wasserspiegellage, berechnungsrelevante stationäre FLYS3 Wasserspiegellagen (", bf("0.5MQ"), ", ", bf("a"), " und ", bf("0.75MQ"), ") und Wasserstände vom 21.12.2016 an der Elbe bei Rosslau und Dessau.")), eval = TRUE}
...
[`waterLevelFlood1`](reference/waterLevelFlood1.html) und 
[`waterLevelFlood2`](reference/waterLevelFlood2.html) implementiert. Diese 
Funktionen berechnen Wasserspiegellagen analog zur Flut1- und Flut2-Methoden der 
...
```{r figure17, fig.show = 'asis', fig.cap = capFig("Wasserspiegellage nach FLYS3 mit dem Bezugspegel Rosslau für den 21.12.2016 an der Elbe bei Rosslau und Dessau."), eval = TRUE}
...
\begin{center}
\url{http://r.bafg.de/shiny/WeberA/02-gauging_data/}
\end{center}

``` {r link_gauging_data, eval = is_html, echo = FALSE, results = 'asis'}
cat('<p style="text-align: center;"><a href="http://r.bafg.de/shiny/WeberA/02-gauging_data/" target="_blank">http://r.bafg.de/shiny/WeberA/02-gauging_data/</a></p>')
```

```{r figure19, echo = FALSE, fig.cap = capFig(paste0("Screenshot der ", link("http://r.bafg.de/shiny/WeberA/02-gauging_data/", "gauging_data-ShinyApp"), " mit Pegelstammdaten, Karte und Wasserstandszeitreihe für den Zeitraum vom 12.04.2017 bis 12.04.2018 am Pegel Rosslau.")), fig.show = 'asis', out.width = "100%",results = 'asis'}
...
\begin{center}
\url{http://r.bafg.de/shiny/WeberA/05-waterlevel/}
\end{center}

``` {r link_waterlevel, eval = is_html, echo = FALSE, results = 'asis'}
cat('<p style="text-align: center;"><a href="http://r.bafg.de/shiny/WeberA/05-waterlevel/" target="_blank">http://r.bafg.de/shiny/WeberA/05-waterlevel/</a></p>')
```

```{r figure20, echo = FALSE, fig.cap = capFig(paste0("Screenshot der ", link("http://r.bafg.de/shiny/WeberA/05-waterlevel/", "waterLevel-ShinyApp"), " mit der interpolierten Wasserspiegellage, berechnungsrelevanten stationären FLYS3 Wasserspiegellagen (", bf("0.5MQ"), ", ", bf("a"), " und ", bf("0.75MQ"), ") und Wasserständen vom 21.12.2016 an der Elbe bei Rosslau und Dessau.")), fig.show = 'asis', out.width = "100%", results = 'asis'}
...
\begin{center}
\url{http://r.bafg.de/shiny/WeberA/06-waterlevelpegelonline/}
\end{center}

``` {r link_waterlevelpegelonline, eval = is_html, echo = FALSE, results = 'asis'}
cat('<p style="text-align: center;"><a href="http://r.bafg.de/shiny/WeberA/06-waterlevelpegelonline/" target="_blank">http://r.bafg.de/shiny/WeberA/06-waterlevelpegelonline/</a></p>')
```

```{r figure21, echo = FALSE, fig.cap = capFig(paste0("Screenshot der ", link("http://r.bafg.de/shiny/WeberA/06-waterlevelpegelonline/", "waterLevelPegelonline-ShinyApp"), " mit der interpolierten Wasserspiegellage, berechnungsrelevanten stationären FLYS3 Wasserspiegellagen (", bf("a"), ", ", bf("0.75MQ"), " und ", bf("b"), ") und Wasserständen vom 13.04.2018 11:00 Uhr an der Elbe bei Rosslau und Dessau.")), fig.show = 'asis', out.width = "100%"}
...
\begin{center}
\url{http://r.bafg.de/~WeberA/hydflood/}
\end{center}

``` {r link_hydflood, eval = is_html, echo = FALSE, results = 'asis'}
cat('<p style="text-align: center;"><a href="http://r.bafg.de/~WeberA/hydflood/" target="_blank">http://r.bafg.de/~WeberA/hydflood/</a></p>')
```
