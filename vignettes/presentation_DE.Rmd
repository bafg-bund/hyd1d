...
output:
  revealjs::revealjs_presentation:
    ...
    fig_height: 6
vignette: |
  %\VignetteIndexEntry{hyd1d & hydflood3} 
...
# Wie erhält man Wasserstandsinformationen für einen Punkt oder eine Strecke an einer Bundeswasserstraße zu einem ausgewählten Zeitpunkt? {#problemstellung data-background="presentation/background.png" data-background-size="auto 800px"}

## {#problemstellung-karte data-background="presentation/map.png" data-background-size="auto 800px"}

## 21.12.2016 {#problemstellung-karte-date data-background="presentation/screenshot_hydflood3_20161221.png" data-background-size="auto 800px"}

## Wie aggregiert man diese flächige Wasserstandsinformation über die Zeit zu Überflutungsdauern? {#problemstellung-flood1 data-background="presentation/background.png" data-background-size="auto 800px"}

## Wie aggregiert man diese flächige Wasserstandsinformation über die Zeit zu Überflutungsdauern? {#problemstellung-flood2 data-background="presentation/background.png" data-background-size="auto 800px"}

[http://hpc-service.bafg.de/shiny/WeberA/07-flood3/](http://hpc-service.bafg.de/shiny/WeberA/07-flood3/)

# PEGELONLINE {#po data-background="presentation/background.png" data-background-size="auto 800px"}

## Abfrage der nächstgelegenen Pegel {#po-query data-background="presentation/background.png" data-background-size="auto 800px"}

- <https://pegelonline.wsv.de/gast/stammdaten?pegelnr=501490>
- <https://pegelonline.wsv.de/gast/stammdaten?pegelnr=502000>

## {#po-query-rosslau data-background="presentation/screenshot_pegelonline_Rosslau.png" data-background-size="auto 750px"}

## {#po-query-dessau data-background="presentation/screenshot_pegelonline_Dessau.png" data-background-size="auto 750px"}

## Wasserstände der angrenzenden Pegel {#po-res1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Lineare Interpolation {#po-res2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
# FLYS {#flys data-background="presentation/background.png" data-background-size="auto 800px"}

## Einleitung {#flys-intro data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Verfügbare Wasserspiegellagen {#flys-wsl1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Verfügbare Wasserspiegellagen {#flys-wsl2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Ausgewählte Wasserspiegellagen {#flys-wsl-sel1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Interpolierte Wasserspiegellagen {#flys-wsl-sel2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Interpolierte Wasserspiegellagen {#flys-wsl-sel3 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Interpolierte Wasserspiegellagen {#flys-wsl-sel4 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Interpolierte Wasserspiegellagen {#flys-wsl-sel5 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Interpolierte Wasserspiegellagen {#flys-wsl-sel6 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Vergleich der Wasserspiegellagen {#flys-wsl-sel7 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Zusammenfassung {#flys-summary data-background="presentation/background.png" data-background-size="auto 800px"}
...
# hyd1d {#hyd1d data-background="presentation/background.png" data-background-size="auto 800px"}

## Einleitung {#hyd1d-intro data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Methodik {#hyd1d-method data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 1. Streckenrelevante Pegel {#hyd1d-method-1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 2. Wasserstände {#hyd1d-method-2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 3. Aufteilung der Berechnungsstrecke {#hyd1d-method-3 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 4. Einrahmende Wasserspiegellagen {#hyd1d-method-4 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 5.1 Gewichtung an den Pegeln {#hyd1d-method-5-1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 5.2 Gewichtung entlang der Strecke {#hyd1d-method-5-2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 5.3 Interpolation der Wasserspiegellage {#hyd1d-method-5-3 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 5.4 Interpolationen zusammengefasst {#hyd1d-method-5-4 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Vergleich der Wasserspiegellagen {#hyd1d-wsl-comp1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Vergleich der Wasserspiegellagen {#hyd1d-wsl-comp2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Vergleich der Wasserspiegellagen {#hyd1d-wsl-comp3 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Zusammenfassung {#hyd1d-summary data-background="presentation/background.png" data-background-size="auto 800px"}
...
# Das R-Paket {#hyd1d-package data-background="presentation/background.png" data-background-size="auto 800px"}

## Installation {#hyd1d-install data-background="presentation/background.png" data-background-size="auto 800px"}
...
## S4-Klasse WaterLevelDataFrame {#hyd1d-s4-1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## S4-Klasse WaterLevelDataFrame {#hyd1d-s4-2 data-background="presentation/background.png" data-background-size="auto 800px"}

```{r hyd1d-s4-2}
str(wldf1, max.level = 2, vec.len = 3, width = 160, strict.width = "cut")
```

## S4-Klasse WaterLevelDataFrame {#hyd1d-s4-3 data-background="presentation/background.png" data-background-size="auto 800px"}

```{r hyd1d-s4-3}
head(as.data.frame(wldf1))
```

## S4-Klasse WaterLevelDataFrame {#hyd1d-s4-4 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## waterLevel...()-Funktionen {#hyd1d-waterLevel data-background="presentation/background.png" data-background-size="auto 800px"}
...
# hydflood3 {#hydflood3 data-background="presentation/background.png" data-background-size="auto 800px"}

## Einleitung {#hydflood3-intro data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Datengrundlagen {#hydflood3-data data-background="presentation/background.png" data-background-size="auto 800px"}
...
## {#hydflood3-data-csa1 data-background="presentation/screenshot_hydflood3_crosssections.png" data-background-size="auto 800px"}

## {#hydflood3-data-csa2 data-background="presentation/screenshot_hydflood3_crosssectionareas.png" data-background-size="auto 800px"}

## {#hydflood3-data-csa3 data-background="presentation/screenshot_hydflood3_crosssectionareas_cs.png" data-background-size="auto 800px"}

## {#hydflood3-data-dem data-background="presentation/screenshot_hydflood3_dem.png" data-background-size="auto 800px"}

## flood3()-Funktion {#hydflood3-algorythm data-background="presentation/background.png" data-background-size="auto 800px"}
...
## 21.12.2016 {#hydflood3-algorythm1 data-background="presentation/screenshot_hydflood3_20161221.png" data-background-size="auto 800px"}

## {#hydflood3-algorythm2 data-background="presentation/screenshot_hydflood3_20161221_video.png" data-background-size="auto 800px"}

## {#hydflood3-video data-background-video="presentation/flood3-2fps-dessau.mp4"}

## 2002 {#hydflood3-algorythm3 data-background="presentation/screenshot_hydflood3_2002.png" data-background-size="auto 800px"}

## 2016 {#hydflood3-algorythm4 data-background="presentation/screenshot_hydflood3_2016.png" data-background-size="auto 800px"}

## Vergleich von Überflutungsdauern {#hydflood3-comp data-background="presentation/background.png" data-background-size="auto 800px"}
...
## Zusammenfassung {#hydflood3-summary data-background="presentation/background.png" data-background-size="auto 800px"}
...
# Das R-Paket {#hydflood3-package data-background="presentation/background.png" data-background-size="auto 800px"}

## Installation {#hydflood3-install data-background="presentation/background.png" data-background-size="auto 800px"}
...
## S4-Klasse hydRasterStack {#hydflood3-s4-1 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## S4-Klasse hydRasterStack {#hydflood3-s4-2 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## S4-Klasse hydRasterStack {#hydflood3-s4-3 data-background="presentation/background.png" data-background-size="auto 800px"}
...
## flood3() {#hydflood3-flood3 data-background="presentation/background.png" data-background-size="auto 800px"}
...
# Produkte {#products data-background="presentation/background.png" data-background-size="auto 800px"}

## {#product-waterlevels data-background="presentation/screenshot_hyd1d_products.png"}
...
## {#product-raster data-background="presentation/screenshot_hydflood3_products.png"}
...
# Veröffentlichung {#publication data-background="presentation/background.png" data-background-size="auto 800px"}

## hyd1d {#hyd1d-publication data-background="presentation/background.png" data-background-size="auto 800px"}
...
## hydflood3 {#hydflood3-publication data-background="presentation/background.png" data-background-size="auto 800px"}
...
# Danke {#thanks data-background="presentation/background.png" data-background-size="auto 800px"}

## Danke {#thanks-list data-background="presentation/background.png" data-background-size="auto 800px"}
...
# Fragen? {#questions data-background="presentation/background.png" data-background-size="auto 800px"}

# Vielen Dank für Ihre Aufmerksamkeit {#thanks-to-you data-background="presentation/background.png" data-background-size="auto 800px"}

# {#contact data-background="presentation/contact.png"}

# {#lenzen data-background-video="presentation/flood3-2fps-lenzen.mp4"}
