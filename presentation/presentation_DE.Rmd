...
output:
  revealjs::revealjs_presentation:
    ...
    fig_height: 6
vignette: |
  %\VignetteIndexEntry{hyd1d and hydflood3}
...
> - **hydflood3** ist als **R**-Paket programmiert und soll über
[CRAN](https://cran.r-project.org) unter der
[GPL2](https://www.gnu.org/licenses/gpl-2.0) veröffentlicht werden
...
- Bisher ist **hydflood3** nur innerhalb der BfG verfügbar und kann mit
...
```{r hydflood3-hydRasterStack-strprep, eval = TRUE, echo = FALSE}
...
## {#hydflood3-references data-background-iframe="http://r.bafg.de/~WeberA/hydflood3/reference/index.html"}
