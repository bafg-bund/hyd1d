...
> - **hyd1d** ist als **R**-Paket programmiert und soll über
...
```{r hyd1d-method-5-1}
{
    ...
    legend("topright", col = c("darkblue", "darkblue", "red", "black"),
           ...
           legend = c("Wasserstand", "Gewicht", "obere FLYS-WSL",
                      "untere FLYS-WSL"), text.font = c(1, 2, 1, 1),
...
> - [waterLevelFlut1()](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevelFlut1.html)
> - [waterLevelFlys3()](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevelFlys3.html)
> - [waterLevelFlys3InterpolateX()](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevelFlys3InterpolateX.html)
> - [waterLevelFlys3InterpolateY()](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevelFlys3InterpolateY.html)
> - [waterLevel()](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevel.html)
> - [waterLevelPegelonline()](http://r.bafg.de/~WeberA/hyd1d/reference/waterLevel.html)

## {#hyd1d-references data-background-iframe="http://r.bafg.de/~WeberA/hyd1d/reference/index.html"}
...
> - **hydflood** ist als **R**-Paket programmiert und soll über
[CRAN](https://cran.r-project.org) unter der
[GPL2](https://www.gnu.org/licenses/gpl-2.0) veröffentlicht werden
...
- Bisher ist **hydflood** nur innerhalb der BfG verfügbar und kann mit
folgenden Befehlen installiert werden:
```{r hydflood-install1, eval = FALSE, echo = TRUE}
install.packages("devtools")
library("devtools")
install_git("git://apps.bafg.de/gitbucket/webera/hydflood.git")
```
...
## S4-Klasse hydRasterStack {#hydflood-s4-1 data-background="background.png" data-background-size="auto 800px"}

> - Eine S4-Klasse auf Basis der S4-Klasse `RasterStack`
> - Beinhaltet RasterLayer des digitalen Geländemodells (`dgm`) und der
Querprofilflächen (`qpf`)
...
> - für diese automatisierte Erstellung eines `hydRasterStack` müssen nur die
Ausdehnung (`ext`) und das Koordinatensystem (`crs`) angegeben werden

## S4-Klasse hydRasterStack {#hydflood-s4-2 data-background="background.png" data-background-size="auto 800px"}

- Initialisierung des `hydRasterStack` mit Nutzer-eigenen Datensätzen
```{r hydflood-hydRasterStack1, eval = FALSE, echo = TRUE}
...
```{r hydflood-hydRasterStack2, eval = FALSE, echo = TRUE}
ext <- extent(x)
crs <- CRS(x)
x <- hydRasterStack(ext = ext, crs = crs)
```

## S4-Klasse hydRasterStack {#hydflood-s4-3 data-background="background.png" data-background-size="auto 800px"}

```{r hydflood-hydRasterStack-strprep, eval = TRUE, echo = FALSE}
...
## {#hydflood-references data-background-iframe="http://r.bafg.de/~WeberA/hydflood/reference/index.html"}
...
## {#product-shiny-waterlevel data-background-iframe="http://r.bafg.de/shiny/WeberA/05-waterlevel/"}

## {#product-shiny-waterlevelpegelonline data-background-iframe="http://r.bafg.de/shiny/WeberA/06-waterlevelpegelonline/"}
...
## {#product-shiny-flood3-wms data-background-iframe="http://r.bafg.de/shiny/WeberA/08-flood3wms/"}
...
> - Shiny-Services [waterLevel()](http://r.bafg.de/shiny/WeberA/05-waterlevel/)
und [waterLevelPegelonline()](http://r.bafg.de/shiny/WeberA/06-waterlevelpegelonline/)
> - Einbettung der Shiny-Services in
[FLYS](https://www.bafg.de/DE/08_Ref/M2/03_Fliessgewmod/01_FLYS/flys_node.html) 3.3
...
> - Shiny-Services [flood3()](http://r.bafg.de/shiny/WeberA/07-flood3/)
und [flood3()-WMS](http://r.bafg.de/shiny/WeberA/08-flood3wms/)
> - Einbettung der WMS-Dienste in [FLYS](https://www.bafg.de/DE/08_Ref/M2/03_Fliessgewmod/01_FLYS/flys_node.html)
3.3
> - Einbettung der Shiny-Services in [FLYS](https://www.bafg.de/DE/08_Ref/M2/03_Fliessgewmod/01_FLYS/flys_node.html)
3.3
