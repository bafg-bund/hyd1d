...
> - Die Auswahl des Bezugspegels kann starken Einfluss auf die resultierende 
Wasserspiegellage haben.
...
## S4-Klasse WaterLevelDataFrame {#package-s4-1}
...
## S4-Klasse WaterLevelDataFrame {#package-s4-2}

```{r package-s4-2}
str(wldf1, max.level = 2, vec.len = 3, width = 160, strict.width = "cut")
```

## S4-Klasse WaterLevelDataFrame {#package-s4-3}

```{r package-s4-3}
head(as.data.frame(wldf1))
```

## S4-Klasse WaterLevelDataFrame {#package-s4-4}
...
## waterLevel...-Funktionen {#package-waterLevel}
...
## {#package-references data-background-iframe="http://hpc-service.bafg.de/~WeberA/hyd1d/reference/index.html"}
