...
author: Arnd Weber, Marcus Hatz, Wolfgang Stürmer, Wilfried Wiechmann, Stephan Rosenzweig, Peter Horchler, Michael Schleuter
...
## 21.12.2016 {#problemstellung-karte-date data-background="map_flooded.png" data-background-size="auto 800px"}
...
```{r hyd1d-wsl-comp2}
{
    ...
    legend("topright", 
           ...
           legend = c("Wasserstand", "PEGELONLINE", "FLYS 3"), cex = cex_legend, 
           bty = "n")
...
```{r hyd1d-wsl-comp3}
{
    ...
    legend("topright", 
           ...
           legend = c("Wasserstand", "PEGELONLINE", "FLYS 3", "hyd1d"), 
...
- Vor der Verwendung muss es geladen werden:
...
## {#hydflood3-data-csa data-background="screenshot_hydflood3_crosssections.png" data-background-size="auto 800px"}

## {#hydflood3-data-csa data-background="screenshot_hydflood3_crosssectionareas.png" data-background-size="auto 800px"}

## {#hydflood3-data-csa data-background="screenshot_hydflood3_crosssectionareas_cs.png" data-background-size="auto 800px"}
...
## {#hydflood3-algorythm1 data-background="screenshot_hydflood3_20161221.png" data-background-size="auto 800px"}

## {#hydflood3-algorythm2 data-background="screenshot_hydflood3_2016.png" data-background-size="auto 800px"}

## {#hydflood3-algorythm3 data-background="screenshot_hydflood3_2002.png" data-background-size="auto 800px"}

## Vergleich von Überflutungsdauern {#hydflood3-comp}

> - Es fehlt ein Vergleich zwischen den Überflutungsdauern nach **flood3** und 
einem 2D- oder 3D-Hydraulik-Modell.
...
## {#product-shiny-flood3 data-background-iframe="http://hpc-service.bafg.de/shiny/WeberA/03-flut3/"}
...
> - Veröffentlichung vorberechneter Wasserspiegellagen für Rhein und Elbe seit dem 01.01.1990
...
> - OpenSource-Software in [R](https://cran.r-project.org)
> - Dokumentationswebseite
> - Veröffentlichung vorberechneter Überflutungsdauerraster von 1990 bis 2017
> - Shiny-Service [flood3()](http://hpc-service.bafg.de/shiny/WeberA/03-flut3/)
> - Veröffentlichung von WMS-Diensten der jährlichen und langfristig gemittelten
Überflutungsdauern
