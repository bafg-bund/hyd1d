...
1. Querprofilspuren aus den SOBEK-Modellen für FLYS, umgerechnet zu Querprofilflächen (`qpf`)
2. Wasserspiegellagen von **hyd1d**
3. Digitale Geländemodelle (`dgm`)
...
2. Übertrag der Wasserspiegellage über das Join-Feld `station_int` auf die 
...
## Zusammenfassung {#product-summary data-background="background.png" data-background-size="auto 800px"}
...
> - Shiny-Services zur interaktiven Berechnung und Darstellung von Überflutungsdauern
...
## hydflood3 {#hydflood-publication data-background="background.png" data-background-size="auto 800px"}
...
# flood3()-Demo {#flood3-result data-background-iframe="http://hpc-service.bafg.de/shiny/WeberA/07-flood3/?_state_id_=530c656e3abaa905"}

[http://hpc-service.bafg.de/shiny/WeberA/07-flood3/?_state_id_=530c656e3abaa905](http://hpc-service.bafg.de/shiny/WeberA/07-flood3/?_state_id_=530c656e3abaa905)
