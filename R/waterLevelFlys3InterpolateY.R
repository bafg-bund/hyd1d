...
#' 
#' @title Compute a 1D water level dataset based on the FLYS 3 algorythm
#' 
#' @description Function to compute 1D water level information based on the
#'   original FLYS 3 algorythm and store it as column \code{w} of an S4 object
#'   of type \linkS4class{WaterLevelDataFrame}.
#' 
