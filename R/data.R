    ...
    if (file.exists("DB_credentials_gauging_data") &
        ...
        query_string <- 
            ...
            WHERE
                ...
                gauging_data.date <= '2025-12-31' AND
                (
...
#'   1960-01-01 until 2025-12-31 are validated and were queried from
#'   (\href{https://www.bafg.de/DE/3_Beraet/2_Exp_quantitaet/Hydrologie_M1/hydrologie_node.html#vt-sprg-3}{WISKI7})-database
#'   and supplied by \email{Datenstelle-M1@@bafg.de}. Data after 2025-12-31 are
...
#'   
#'   \if{html}{\figure{flys3waterlevels.png}{options: alt="Figure: flys3waterlevels.png" style="text-align: center; width: 576px; height: 576px;"}}
